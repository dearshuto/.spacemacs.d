...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (setq spacemacs-evil-cursors '(("normal" "SkyBlue2" bar)
                                 ("insert" "chartreuse3" (bar . 2))
                                 ("emacs" "SkyBlue2" bar)
                                 ("hybrid" "DarkGoldenrod2" bar)
